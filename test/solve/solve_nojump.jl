...
@testset "Solving the no jump equilibrium using Li2020" begin
    truep    = h5read("../reference/models/li2020/solve_nojump_li2020_eqm.h5", "p")
    truedpdw = h5read("../reference/models/li2020/solve_nojump_li2020_eqm.h5", "dpdw")
    ...
    for (k, v) in endogenous_variables
        trueval = h5read("../reference/models/li2020/solve_nojump_li2020_eqm.h5", string(detexify(k)))
